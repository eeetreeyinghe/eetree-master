...
mix.js('resources/js/app.js', 'public/js')
   .extract(['vue', 'element-ui', 'jquery'])
   .js('resources/js/ucenter.js', 'public/js')
   .js('resources/js/validate.js', 'public/js')
   .js('resources/js/pages/doc_detail.js', 'public/js/pages')
   .js('resources/js/pages/doc_edit.js', 'public/js/pages')
   .js('resources/js/pages/prj_detail.js', 'public/js/pages')
   .js('resources/js/pages/pay.js', 'public/js/pages')
