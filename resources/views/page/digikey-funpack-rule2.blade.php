...
@section('content')
  ...
  <div class="content-wrapper bg-white content-rule">
    ...
    <div class="topBanner rule-step-img">
      <img alt="DK活动流程介绍" title="DK活动流程介绍" src="/storage/page/digikey-funpack/image/2/rule-steps.png"/>
    </div>
    <div class="content" style="width:auto;">
      <div class="rules-text-p">
        <p>1. 第二期板卡购买链接：请进入<a href="https://www.eetree.cn/page/digikey-funpack" target="_blank">https://www.eetree.cn/page/digikey-funpack</a>页面点击“得捷购”，进行购买</p>
        <p>2. 本期板卡直播安排在10月19日，主要介绍板卡上手使用方法</p>
        <p>3. 用户在11月15日前完成指定任务，通过邮件提交指定材料给硬禾，提交时间截止到11月15日晚23:59</p>
        <p>4. 审核通过者，由硬禾工作人员直接联系，发放购买板卡等值的京东购物券</p>
      </div>
      <h4>二、材料提交要求</h4>
      <div class="rules-text-p">
        <p>指定时间内完成指定任务，需要提交以下材料，发送邮件到：funpack@eetree.cn，邮件命名：Funpack第二期 – 姓名（请填写真实姓名）</p>
        <p>1. 3-5分钟短视频</p>
        <div class="rules-p-child">
          ...
          <div class="rules-p-child">
            ...
            <p>· 通过Arduino接口成功驱动SPI、I2C、UART三种外设中的其中一个，且在拍视频时显示出来。</p>
          </div>
        </div>
