...
@section('content')
  ...
  <div class="content-wrapper bg-white content-rule">
    <h3 class="text-center rule-title">Funpack第九期活动规则</h3>
    <div class="content" style="width:auto;">
      ...
      <div class="topBanner rule-step-img">
        <img alt="DK活动流程介绍" title="DK活动流程介绍" src="/storage/page/digikey-funpack/image/9/rule-steps.png"/>
      </div>
      <div class="rules-text-p">
        <p>1. 下单：请在Funpack首页(<a href="https://www.eetree.cn/page/digikey-funpack" target="_blank">https://www.eetree.cn/page/digikey-funpack</a>) 点击“得捷购”，下单第九期板卡</p>
        <p>2. 直播：第九期直播安排在2021年5月20日</p>
        <p>3. 截止日期：参与者需在2021年6月20日晚上12点前完成指定任务，通过邮件提交指定材料给硬禾</p>
        <p>4. 活动返还：审核通过者返还与购买板卡费用等值的京东购物券</p>
      </div>
      <div class="bordere5"></div>
      <h4>三、第九期指定完成的任务</h4>
      <div class="rules-text-p">
        <p>活动参与者可从下面三个任务中任选其一完成：</p>
        <p>
          <b>任务一：</b>
          <br />如右图所示，使用SensorTile.box 立方体较大的四个面，实现四个不同的功能，如：
        </p>
        <img src="/storage/page/digikey-funpack/image/9/rule-sample.png" style="float:right;width:160px;margin-left:5px" />
        ...
        <p>
          <b>任务二：</b>
          <br />搭建可随身携带的环境监测系统，记录一段时间的环境数据，并导出查看(要求解释数据的变化）
        </p>
        <p>
          <b>任务三：</b>
          <br />使用神经网络系统，实现特定声音检测功能，如：口哨、咳嗽、鸟叫等，可参考官方提供的婴儿啼哭检测
        </p>
      </div>
      <div class="bordere5"></div>
      <h4>四、材料提交要求</h4>
      <div class="rules-text-p">
        ...
        <p>
          ...
          <br />邮件请命名为：Funpack第九期订单 – 姓名（请填写真实姓名）
          <br />邮件正文请按以下格式填写相应信息：
        </p>
        <div class="rules-p-child">
          <p>· 姓名</p>
        ...
        <p>
          2. 在6月20晚上12点之前将以下材料提交到电子森林项目网站，提交方法请见<a href="/page/digikey-funpack/help">详细说明</a>
          <br />【项目标题需包含关键字：“Funpack第九期”、“SensorTile.box”，及所完成任务的关键字，其他可自由发挥。】：
        </p>
        <div class="rules-p-child">
        ...
        <p>
          3. 在截止日期之前将以下内容发送到 funpack@eetree.cn 邮箱，以作最后材料关联和京东券的返还。邮件请命名为：Funpack第九期 – 姓名（请填写真实姓名）
        </p>
        <div class="rules-p-child">
      ...
      <h4>六、微信交流群</h4>
      <div class="rules-text-p">
        <p>请关注“<b>硬禾学堂</b>”微信公众号，并发送关键字“<b>STM32</b>”或“<b>Funpack9</b>”获取群二维码进群交流（我们采用回复关键词的方法，维护群聊，尽力为大家提供一个干净的技术交流环境）。</p>
