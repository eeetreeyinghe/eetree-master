...
@section('content')
  ...
  <div class="content-wrapper bg-white content-rule">
    <h3 class="text-center rule-title">Funpack第11期活动规则</h3>
    <div class="content" style="width:auto;">
      ...
      <div class="topBanner rule-step-img">
        <img alt="DK活动流程介绍" title="DK活动流程介绍" src="/storage/page/digikey-funpack/image/11/rule-steps.png?1"/>
      </div>
      <div class="rules-text-p">
        <p>1. 下单：请于9月1日-9月20日在Funpack首页(<a href="https://www.eetree.cn/page/digikey-funpack" target="_blank">https://www.eetree.cn/page/digikey-funpack</a>) 点击“得捷购”，下单第11期板卡</p>
        <p>2. 直播：第11期直播安排在2021年9月24日</p>
        <p>3. 截止日期：参与者需在2021年10月31日晚上12点前完成指定任务，通过邮件提交指定材料给硬禾</p>
      ...
      <div class="rules-text-p">
        ...
        <p>
          <b>任务一：</b>
          <br />读取SD卡（SD卡自备）中的音频文件，使用板卡上的3.5mm音频接口播放音乐。
        </p>
        <p>
          <b>任务二：</b>
          <br />读取SD卡中预先存入的图像，显示在屏幕上(OLED或LCD）
        </p>
        <p>
          <b>任务三：</b>
          <br />实现USB-UART Hub，自己设计通信方式，实现USB到多路UART的收发。
        </p>
        <p>
          <b>任务四：</b>
          <br />移植Micropython，并实现串口通信和控制IO口。
        </p>
        <img src="/storage/page/digikey-funpack/image/11/rule-sample.png" class="phone-show" />
      </div>
      <div class="bordere5"></div>
      <h4>四、材料提交要求</h4>
      <div class="rules-text-p">
        ...
        <p>
          ...
          <br />邮件请命名为：Funpack第11期订单 – 姓名（请填写真实姓名）
          <br />邮件正文请按以下格式填写相应信息：
        </p>
        ...
        <p>
          2. 在10月31晚上12点之前将以下材料提交到电子森林项目网站，提交方法请见<a href="/page/digikey-funpack/help">详细说明</a>
          <br />【项目标题需包含关键字：“Funpack第11期”、“LPC55S69”，及所完成任务的关键字，其他可自由发挥。】：
        </p>
        <div class="rules-p-child">
        ...
        <p>
          ...
          <br />邮件请命名为：Funpack第11期 – 姓名（请填写真实姓名）
        </p>
        <div class="rules-p-child">
      ...
      <h4>六、微信交流群</h4>
      <div class="rules-text-p">
        <p>请关注“<b>硬禾学堂</b>”微信公众号，并发送关键字“<b>LPC55S69</b>”或“<b>Funpack11</b>”获取群二维码进群交流（我们采用回复关键词的方法，维护群聊，尽力为大家提供一个干净的技术交流环境）。</p>
